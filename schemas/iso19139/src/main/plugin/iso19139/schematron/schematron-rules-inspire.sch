...
-->
	...
	<sch:pattern>
		...
		<sch:rule context="//gmd:MD_DataIdentification|
			...
			-->
            <sch:let name="thesaurusURL" value="concat('file:///', replace($thesaurusDir,'\','/'), '/external/thesauri/theme/inspire-theme.rdf')"/>
	...
	<sch:pattern>
		...
		<sch:rule context="//srv:SV_ServiceIdentification|//*[@gco:isoType='srv:SV_ServiceIdentification']">
			<!-- Check that INSPIRE service taxonomy is available.
				Use INSPIRE thesaurus available on SVN to check keywords in all EU languages.
			-->
			<sch:let name="inspire-thesaurus" value="document(concat('file:///', replace($thesaurusDir,'\','/'), '/external/thesauri/theme/inspire-service-taxonomy.rdf'))"/>
